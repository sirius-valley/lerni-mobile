...
const useTrivia = () => {
    ...
    const {data: triviaData, error: triviaError, isLoading: triviaLoading, isSuccess: triviaSuccess} = useTriviaByIdQuery({triviaId: triviaId as string},{
        skip: !triviaId,
    })
    const [answerQuestion, {data: answerData, error: answerError, isLoading: answerLoading, isSuccess: answerSuccess}] = useAnswerTriviaMutation()
